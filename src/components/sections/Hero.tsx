        ...
        >
          ...
          >
            {[
              ...
              <div key={stat.label} className="flex items-center gap-8 max-sm:gap-5">
                {i > 0 && <div className="w-px h-12 bg-gradient-to-b from-transparent via-border to-transparent shrink-0 max-sm:w-12 max-sm:h-px max-sm:bg-gradient-to-r" />}
